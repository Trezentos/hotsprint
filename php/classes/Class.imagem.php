...
/* ------------------------------------------------------------------------ */
/* CREATE - Manuel Reinhard
/* UPDATE -> output WEBP -> Willian West
/* ------------------------------------------------------------------------ */
...
class Image {
     ...
     */
    public function resize($max_width, $max_height, $method="fit", $cropAreaLeftRight="c", $cropAreaBottomTop="c", $jpgQuality=80, $fileType="")
    {
        $width  = $this->getWidth();
        ...
        // SET IMAGE
        if($image_save_func == "imageJPG" || $image_save_func == "ImageJPEG" || $image_save_func == 'ImageWEBP')
        {
    ...
    protected function getFunctionNames()
    {
        ...
        switch ($this->getType()) {
            case 'jpg':
            case 'jpeg':            $image_create_func = 'ImageCreateFromJPEG'; break;
            case 'png':             $image_create_func = 'ImageCreateFromPNG';  break;
            case 'bmp':             $image_create_func = 'ImageCreateFromBMP';  break;
            case 'gif':             $image_create_func = 'ImageCreateFromGIF';  break;
            case 'vnd.wap.wbmp':    $image_create_func = 'ImageCreateFromWBMP'; break;
            case 'xbm':             $image_create_func = 'ImageCreateFromXBM';  break;
            case 'webp':            $image_create_func = 'ImageCreateFromWEBP'; break;
            default:                $image_create_func = 'ImageCreateFromJPEG';
        }

        switch ($this->newFileType) {
            case 'jpg':
            case 'jpeg':         $image_save_func = 'ImageJPEG';    break;
            case 'png':          $image_save_func = 'ImagePNG';     break;
            case 'bmp':          $image_save_func = 'ImageBMP';     break;
            case 'gif':          $image_save_func = 'ImageGIF';     break;
            case 'vnd.wap.wbmp': $image_save_func = 'ImageWBMP';    break;
            case 'xbm':          $image_save_func = 'ImageXBM';     break;
            case 'webp':         $image_save_func = 'ImageWEBP';    break;
            default:             $image_save_func = 'ImageWEBP';
        }
